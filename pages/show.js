...
export default function ShowHN() {
    const { data: posts, isLoading, error } = useQuery(['posts', 'Show HN'], () => fetchPostsByCategory('Show HN'));
    ...
    return (
        <div className="max-w-4xl mx-auto p-4">
            <Title level={2} className="text-center mb-6">Show HN</Title>
            <List
                dataSource={posts}
                renderItem={post => (
                    <List.Item
